...
{   
	TFT_LCD_mWriteReg(XPAR_LCD_S00_AXI_BASEADDR,TFT_LCD_S00_AXI_SLV_REG0_OFFSET, reg + data); //write reg
	TFT_LCD_mWriteReg(XPAR_LCD_S00_AXI_BASEADDR,TFT_LCD_S00_AXI_SLV_REG0_OFFSET, nreset + data); //write reg
}
...
{	  
	TFT_LCD_mWriteReg(XPAR_LCD_S00_AXI_BASEADDR, TFT_LCD_S00_AXI_SLV_REG0_OFFSET,is_data + data); //write data
	TFT_LCD_mWriteReg(XPAR_LCD_S00_AXI_BASEADDR,TFT_LCD_S00_AXI_SLV_REG0_OFFSET, nreset + data); //write reg
}
//写寄存器
//LCD_Reg:寄存器地址
...
void LCD_Init(void)
{ 	 
	Xil_Out32(XPAR_LCD_S00_AXI_BASEADDR + TFT_LCD_S00_AXI_SLV_REG0_OFFSET, nreset);//rst = 0;
	Xil_Out32(XPAR_LCD_S00_AXI_BASEADDR +TFT_LCD_S00_AXI_SLV_REG0_OFFSET, reset);//rst = 1;
	Xil_Out32(XPAR_LCD_S00_AXI_BASEADDR + TFT_LCD_S00_AXI_SLV_REG0_OFFSET, nreset);//rst = 0;
 	lcddev.id = 0x5510;
 	LCD_Display_Dir(0);
